...
-- ---------------------------------------------------------------------
-- Demostrar que si la sucesión aₙ converge a L, entonces |aₙ| converge
-- a |L|.
-- ---------------------------------------------------------------------
...
-- Sea bₙ = |aₙ|, para todo n. Tenemos que demostrar que bₙ converge a
-- |L|. Para ello, sea ε > 0 y hay que probar que existe un k tal que,
--    ∀ n ≥ k, |bₙ - |L|| < ε                                        (1)
--
...
-- Entonces,
--    |bₙ - |L|| = ||aₙ| - |L||
--               ≤ |aₙ - L|     [por la desigualdad triangular inversa]
--               < ε            [por (2) y (3)]
